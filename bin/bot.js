...
app.post('/buttons-actions', urlencodedParser, (req, res) =>{
    ...
    if(actionJSONPayload.actions[0].value === "dont_allow"){
        ...
        console.log("new ts="+actionJSONPayload.original_message.attachments[0].ts);
        var params ={ts: actionJSONPayload.original_message.attachments[0].ts.replace("0000000000","."), channel: original_channel, as_user: true}
