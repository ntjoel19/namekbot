...
function Bot(params) {
    ...
    this.admin_name = params.me_token;
...
Bot.prototype.postMessage = function(id, text, params) {
    ...
    //console.log("parameters = "+util.inspect(params, false, null));
...
Bot.prototype._api = function(methodName, params) {
    if(methodName === "chat.delete")
    {
        params = extend(params || {}, {token: this.me_token});
        console.log("xb"+this.me_token+"sdlkkk");
    ...
    return new Vow.Promise(function(resolve, reject) {
        ...
        request.get(data, function(err, request, body) {
            ...
            try {
                ...
                if(methodName === "chat.delete")
                    console.log("the task is = "+JSON.stringify(body));
